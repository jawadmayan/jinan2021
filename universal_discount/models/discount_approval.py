...
class sale_discount(models.Model):
    ...
    def action_confirm(self):
        ...
        if self.company_id.so_double_validation == 'two_step':
            ...
            if self.ks_global_discount_type == 'amount' :

                amount_percent = self.amount_untaxed / 100
                percent = self.ks_global_discount_rate / amount_percent
                discnt = percent
            else :
                discnt = self.ks_global_discount_rate
